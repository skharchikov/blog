        ...
        <div class="projects-container">
            ...
            <div class="projects-list">
                {projects.iter().map(|project| {
                    ...
                    view! {
                        // Stretched-link card: the project name is the real link (its
                        // ::after covers the card for whole-card click); the GitHub link
                        // is a sibling that sits above it — no nested anchors.
                        <div class="project-card">
                            <div class="project-header">
                                <h2 class="project-name">
                                    <A href={project_url} class="project-card-link">{&project.name}</A>
                                </h2>
                                <a
